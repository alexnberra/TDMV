...
class UserFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'tribal_enrollment_id' => fake()->unique()->bothify('TID-######'),
            'name' => "{$firstName} {$lastName}",
            'first_name' => $firstName,
            'last_name' => $lastName,
            'middle_name' => fake()->boolean(30) ? fake()->randomLetter().'.' : null,
    ...
    {
        return $this->state(fn (): array => ['role' => 'member']);
    }

    public function staff(): static
    {
        return $this->state(fn (): array => ['role' => 'staff']);
    }
